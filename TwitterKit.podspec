Pod::Spec.new do |s|
  ...
  s.homepage = "https://github.com/divbyzero/twitter-kit-ios"
  s.documentation_url = "https://github.com/divbyzero/twitter-kit-ios/wiki"
  s.social_media_url = "https://redwerk.com"
  s.authors = "Redwerk OU"
  s.platform = :ios, "9.0"
  s.source = { :http => "https://github.com/divbyzero/twitter-kit-ios/releases/download/v#{s.version}/TwitterKit.zip" }
